...
def init_ee():
    try:
        # Cloud deploy: service account from Streamlit secrets
...
def geocode_place(query):
    """Forward geocoding: place name → lat/lon via Nominatim (India only)."""
    try:
...
# If a pond was just added, focus on it instead
